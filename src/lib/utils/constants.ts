...
export const AI_PROVIDERS = {
  openrouter: {
    ...
    keyHintKey: 'provider_hint_openrouter' as const,
  ...
  openai: {
    ...
    keyPlaceholder: 'sk-...',
    keyHintKey: 'provider_hint_openai' as const,
    format: 'openai' as const,
  },
  anthropic: {
    name: 'Anthropic',
    ...
    keyHintKey: 'provider_hint_anthropic' as const,
  ...
  google: {
    ...
    keyPlaceholder: 'AIza...',
    keyHintKey: 'provider_hint_google' as const,
    format: 'openai' as const,
  },
  custom: {
    ...
    keyHintKey: 'provider_hint_custom' as const,
    format: 'openai' as const,
  },
} as const;
