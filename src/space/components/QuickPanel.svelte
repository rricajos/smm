...
<section class="section">
  ...
  <div class="input-row">
    <textarea
      ...
      placeholder={$t('ai_quick_describe_placeholder')}
      rows="3"
      disabled={loading}
    ></textarea>
...
{#if loading}
  <div class="loading">
    ...
    <span>{$t('ai_quick_consulting')}</span>
  </div>
{/if}
      ...
      {#each suggestions as suggestion (suggestion.rule.name)}
        <div class="suggestion-card">
          <div class="suggestion-header">
            ...
            <span class="confidence {confidenceClass(suggestion.confidence)}">
              {$t('ai_confidence_label', {
                level: confidenceLabel(suggestion.confidence),
          ...
          <div class="suggestion-actions">
            ...
            <Button variant="danger" size="sm" onclick={() => ondiscard(suggestion)}
